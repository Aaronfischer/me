...
<!--                             <div class="swiper-slide bg-contain slide-fhfc">
        ...
        <!--                     <div class="col-12 pad-col-12 desk-col-13 padding">
                        <div class="row cf">
                            <div class="col-50p">
                                <h1>Projects</h1>
                                <ul>
                                    <li><a href="http://rmcad.edu">RMCAD | Rocky Mountain College of Art and Design</a></li>
                                    <li><a href="http://dome.rmcad.edu">RMCAD | The Dome</a></li>
                                    <li><a href="http://modmed.com">Modernizing Medicine</a></li>
                                    <li><a href="http://directory.floridahospital.com">Florida Hosptial for Children Specialist Directory</a></li>
                                    <li><a href="http://creativebeverages.com">Creative Beverages</a></li>
                                    <li><a href="http://fhgme.com">FHGME</a></li>
                                    <li><a href="http://bonnettdesigngroup.com">Bonnett Design Group</a></li>
                                    <li><a href="http://martinandmalkemus.com">Martin & Malkemus</a></li>
                                    <li><a href="http://objectostudios.com">Objecto Studios</a></li>
                                    <li><a href="http://scottarchitecture.com">SAID</a></li>
                                    <li><a href="http://www.slocumplatts.com/">Slocum Platts Architects</a></li>
                                    <li><a href="http://mediterraneanblue.net/">Mediterranean Blue</a></li>
                                    <li><a href="http://furniturevoyeur.com/">Furniture Voyeur</a></li>
                                    <li><a href="http://www.petercetera.com/">Peter Cetera</a></li>
                                </ul>
                            </div>
                            <div class="col-50p">
                                <h1>Brands</h1>
